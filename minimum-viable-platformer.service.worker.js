...
/** @type {string} */
const CACHE_VERSION = '1782150358|1114447916';
/** @type {string} */
const CACHE_PREFIX = 'minimum-viable-p-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'minimum-viable-platformer.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["minimum-viable-platformer.html","minimum-viable-platformer.js","minimum-viable-platformer.offline.html","minimum-viable-platformer.icon.png","minimum-viable-platformer.apple-touch-icon.png","minimum-viable-platformer.audio.worklet.js","minimum-viable-platformer.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["minimum-viable-platformer.wasm","minimum-viable-platformer.pck"];
